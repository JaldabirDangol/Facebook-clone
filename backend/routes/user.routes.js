...
import { signup , login ,logout ,getProfile, editProfile, suggestedUser ,freindsOrunfreinds, searchUser, getFriends, userDetail ,getAllUsers, deleteAccount, changePassword } from '../controller/user.controller.js'
